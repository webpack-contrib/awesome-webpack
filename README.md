...
- [Duplicate Dependencies Webpack Plugin](https://github.com/fengzilong/duplicate-dependencies-webpack-plugin) - Report duplicated dependencies included in your bundle, no extra fs calls, and with more detailed and fancy reporter -- *Maintainer*: `fengzilong` [![Github][githubicon]](https://github.com/fengzilong)
