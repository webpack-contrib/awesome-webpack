...
- [webpack variable replacer plugin](https://github.com/eaTong/webpack-variable-replacer-plugin) - easy to change css variable with only one function. -- *Maintainer* `eaTong` [![Github][githubicon]](https://github.com/eaTong) 
