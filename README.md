...
- [Rockpack](https://github.com/AlexSergey/rockpack) - Rockpack is a simple solution for creating React Application with Server Side Rendering, bundling, linting, testing within 5 minutes.
