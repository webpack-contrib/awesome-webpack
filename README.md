...
- [Webpacker](https://github.com/rails/webpacker) - Offical webpack gem for integration for ruby on rails projects  -- *Maintainer*: `Rails` [![Github][githubicon]](https://github.com/rails)
