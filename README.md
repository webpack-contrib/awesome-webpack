...
- [Markup-inline Loader](https://github.com/asnowwolf/markup-inline-loader) Inline SVGs to HTML. It’s useful when applying icon font or applying CSS animation to SVG. -- *Maintainer*: `Zhicheng Wang` [![Github][githubicon]](https://github.com/asnowwolf)
...
- [Sass Webpack Plugin](https://github.com/jalkoby/sass-webpack-plugin) - SASS plugin for webpack. -- *Maintainer*: `Sergey Pchelintsev`  [![Github][githubicon]](https://github.com/jalkoby) [![Twitter][twittericon]](https://twitter.com/jalkoby)
...
- [Webpack Chain](https://github.com/mozilla-neutrino/webpack-chain): A chaining API to generate and simplify the modification of Webpack 2 configurations. -- *Maintainer*: `Eli Perelman` [![Github][githubicon]](https://github.com/eliperelman)
